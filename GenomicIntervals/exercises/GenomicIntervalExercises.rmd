...
##
Extract -500,+500 bp regions around TSSes on chr20. Use H3K4me3 and H3K4me1 ChIP-seq enrichment data in the data folder and create heatmaps and average signal profiles for regions around the TSSes.

## 
Visualize one of the regions using `Gviz` functions. You should visualize both H3K4me3 and H3K4me1 and the gene model.
